...
import com.alterra.submission.logging.LoggingFilter;
import com.alterra.submission.util.CustomHttpServletRequestWrapper;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (token != null && ! StringUtils.isEmpty(token) && jwtTokenProvider.validateToken(token, request, requestBody)) {
